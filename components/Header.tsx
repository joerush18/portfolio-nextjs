...
const Header = () => {
  ...
  return (
    <>
      <div className="bg-backgroundContent rounded-2xl px-4 py-3  shadow-md space-x-6 sticky top-2 z-40 block min-w-[480px] sm:w-[100%]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex justify-center items-center">
            ...
            <Link href="/posts">
              <div
                className={
                  active === "posts" ? `navButton active` : `navButton `
                }
                onClick={() => {
                  setActive("posts");
                }}
